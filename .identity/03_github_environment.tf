...
locals {
  env_secrets = {
    ...
    "RECEIPTS_COSMOS_ENDPOINT" : "AccountEndpoint=https://pagopa-${var.env_short}-${local.location_short}-${local.domain}-ds-cosmos-account.documents.azure.com:443/",
    "BIZ_COSMOS_ENDPOINT" : "AccountEndpoint=https://pagopa-${var.env_short}-${local.location_short}-${local.domain}-ds-cosmos-account.documents.azure.com:443/",
    "RECEIPTS_COSMOS_KEY": "${data.azurerm_cosmosdb_account.receipts_cosmos.primary_key}",
    "BIZ_COSMOS_KEY": "${data.azurerm_cosmosdb_account.biz_cosmos.primary_key}",
